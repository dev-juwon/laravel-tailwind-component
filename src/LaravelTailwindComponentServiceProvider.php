...
class LaravelTailwindComponentServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->publishes([
                __DIR__.'/../config/config.php' => config_path('laravel-tailwind-component.php'),
            ], 'config');
            ...
            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/laravel-tailwind-component'),
            ], 'assets');*/

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/laravel-tailwind-component'),
            ], 'lang');*/
